  ...
  `((custom-theme-set-faces
    ...
    (custom-theme-set-variables
     ...
     `(org-todo-keyword-faces
       '(("CANCELLED" :foreground "#cccccc" :weight bold)
         ("ONHOLD"    :foreground "#cccccc" :weight bold)
         ("STALLED"   :foreground "#cccccc" :weight bold)
         ("SUBMITTED" :foreground "#cccccc" :weight bold)
